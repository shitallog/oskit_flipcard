...
<head>
  ...
  <link rel="stylesheet" href="/assets/css/owl.theme.default.min.cssa">
...
<body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav m-auto mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="our-activities.html">Our Activities</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="online-admission.html">Online Admission</a>
            </li>
          </ul>
    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center fadeInUp ftco-animated">
          ...
          <p class="breadcrumbs text-white"><span class="mr-2"><a href="index.html"
                class="text-white text-decoration-none">Home
      ...
      <div class="row">
        <div class="col-md-12 col-lg-7 col-sm-12 pt-2 ftco-animate">
          <div class="contact-info shadow">
		   <form action="{{route('pages.online-admission')}}" method="POST">
        @csrf
  <div class="row">
 ...
 <!-- Your form fields here -->
        ...
        <input type="text" name="student_name"  class="form-control form-control-lg causes-text"
	  ...
	  <div class="col-md-6 mb-4">
	   <!-- Your form fields here -->
        ...
        <input type="text" name="father_name"  class="form-control form-control-lg causes-text" required>
 </div>
     </div>
	 <div class="col-md-6 mb-4">
	   <!-- Your form fields here -->
        ...
        <input type="text" name="mother_name"  class="form-control form-control-lg causes-text" required>
</div>
     </div>
	 	 <div class="col-md-6 mb-4">
	   <!-- Your form fields here -->
        ...
        <input type="text" name="last_name" class="form-control form-control-lg causes-text" required>
</div>
     </div>
	  <div class="col-md-6 mb-4">
	   <!-- Your form fields here -->
        ...
        <input type="text" name="mobile_number" class="form-control form-control-lg causes-text" required>
</div>
     </div>
	  <div class="col-md-6 mb-4">
	   <!-- Your form fields here -->
        ...
        <input type="email" name="email" class="form-control form-control-lg causes-text" required>
</div>
     </div>
	   <div class="col-md-6 mb-4">
	   <!-- Your form fields here -->
        ...
        <input type="text" name="nationality" class="form-control form-control-lg causes-text" required>
</div>
     </div>
	  <div class="col-md-6 mb-4">
	   <!-- Your form fields here -->
        ...
        <input type="date" name="date_of_birth" class="form-control form-control-lg causes-text" required>
</div>
     </div>
	  <div class="col-md-6 mb-4">
	   <!-- Your form fields here -->
        ...
        <select name="gender" class="form-control form-control-lg causes-text" required>
 ...
 <div class="col-md-6 mb-4">
	   <!-- Your form fields here -->
        ...
        <select name="marital_status" class="form-control form-control-lg causes-text" required>
 ...
 <div class="col-md-6 mb-4">
	   <!-- Your form fields here -->
        ...
        <input type="text" class="form-control form-control-lg causes-text" name="adhar_number" required>
		</div>
     </div>
 <div class="col-md-6 mb-4">
	   <!-- Your form fields here -->
        ...
        <select name="category" class="form-control form-control-lg causes-text" required>
 ...
 <div class="col-md-6 mb-4">
	   <!-- Your form fields here -->
        ...
        <select name="course" class="form-control form-control-lg causes-text" required>
 ...
 <div class="col-md-6 mb-4">
	   <!-- Your form fields here -->
        ...
        <textarea name="address" class="form-control form-control-lg causes-text" rows="4" required></textarea>
</div>
     </div>   </div>
	   <div class="mb-3 admission-submit">
        ...
        <div class="col-md-12 col-lg-5 col-sm-12 pt-2 ftco-animate">
          <div class="contact-info shadow">
            ...
            <img src="/assets/images/online-admission.png" alt="" width="100%">
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-3 col-md-6 ftco-animate">
            ...
            <ul class="footer-list">
              ...
              <li><a href="contact-us.html" class="text-decoration-none text-white-90"><i
                    class="fa-solid fa-angles-right"></i>&nbsp; Contact</a></li>
              <li><a href="online-admission.html" class="text-decoration-none text-white-90"><i
